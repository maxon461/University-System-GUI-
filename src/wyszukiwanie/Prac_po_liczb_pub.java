...
public class Prac_po_liczb_pub {
    public void wyswetl(Data data , int x){
        ...
        for(int i=0;i<data.osoba.size();i++){
            if(data.osoba.get(i) instanceof Pracownik_administracyjny && ((Pracownik_administracyjny)data.osoba.get(i)).get_liczba_nadgodzin()==x){
